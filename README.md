# Итоговый проект "Пиццерия"

<br>
**Состояние:**
  > микросервис restaurant и warehouse в приличном состоянии по коду
  > микросервис site приемлеемое состояние
  > остальные требуют рефакторинга, но отлично работают
<br>
